...
ggplot(data = world) +
  geom_sf() +
  ggtitle("Counties of the World", subtitle = "Created by Pamela Oda")
```
...
ggplot() +
  geom_sf(data = world_without_antarctica,
          fill = "#eeb4b4", color = "#bc8f8f", size = 0.25) +
  ggtitle("Countries of the World", subtitle = "without Antarctica")
...
```{r}
ggplot(data = world) +
  geom_sf(fill = "#eeb4b4", color = "#bc8f8f", size = 0.25) +
  coord_sf(crs = "+proj=ortho +lat_0=19 +lon_0=-155 ") +
  ggtitle("Hilo, HI as the Center of the World", subtitle = "Orthographic Azimuthal") +
  theme_void()
```
